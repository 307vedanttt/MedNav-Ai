        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7">
            ...
            <motion.div variants={containerVariants} initial="hidden" animate="show" className="space-y-4">
              {prescriptions.map((rx, idx) => <motion.div variants={itemVariants} key={idx} className="glass-panel p-5 rounded-2xl border border-outline-variant/15 flex items-center gap-5 hover:border-primary/30 transition-all cursor-pointer group">
