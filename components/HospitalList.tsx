...
export default function HospitalList({ hospitals, isLoading, selectedHospitalId, onSelect, onNavigate, onCallEMS, userLocation }: HospitalListProps) {
  return (
    <div className="flex flex-col h-full max-h-[500px]">
      ...
      <div className="flex-1 overflow-y-auto pr-2 space-y-3 custom-scrollbar relative">
        ...
        {!isLoading && hospitals.length === 0 && (
          <div className="glass-panel p-8 text-center rounded-xl border border-outline-variant/15 border-dashed">
