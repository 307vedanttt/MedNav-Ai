...
export default function Header() {
  ...
  return <motion.header initial={{
    ...
    stiffness: 300,
    damping: 30
  }} className="fixed top-0 w-full z-50 bg-white/90 backdrop-blur-md shadow-md border-b border-gray-200 transition-colors duration-300">
      <nav className="flex justify-between items-center px-6 py-3 max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex gap-6 items-center">
          ...
          return <Link key={link.name} href={link.href} className={`relative text-xs tracking-widest uppercase font-medium px-2 py-1 transition-all duration-300
